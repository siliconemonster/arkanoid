...
int main(int argc, char **argv)
{
  ...
  else
  {
      ...
      else
      {
        ...
        gameState.ball = createBall ((gameState.player.posX + 24), (gameState.player.posY - 20), gBallSurface);
        ...
        while( !quit )
        {
              ...
              SDL_FillRect( gScreenSurface, &gameState.level, SDL_MapRGB( gScreenSurface->format, 0x00, 0x00, 0xFF ));
